...
Complete token definitions for `tokens.css`. Copy this file as-is into your project's `src/styles/tokens.css`.
...
:root {
  ...
  /* ============================================
     8. BREAKPOINTS (used in JS via useBreakpoint)
     ============================================ */
  --bp-sm:  640px;
  --bp-md:  768px;
  --bp-lg:  1024px;
...
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --color-accent-100: #2D2A6E;
    --color-accent-600: #818CF8;
    --color-accent-700: #A5B4FC;
...
Always reference tokens through CSS custom properties. Never hardcode values.
